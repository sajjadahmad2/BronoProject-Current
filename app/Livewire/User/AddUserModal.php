...
class AddUserModal extends Component
{
    ...
    public function render()
    {
        ...
        $checked_permissions =  $permissions->pluck('name')->toArray();
        $roles_description = [
            'superadministrator' => 'Best for business owners and company administrators',
            'company' => 'Best for developers or people primarily using the API',
            'user' => 'Best for people who need full access to analytics data, but don\'t need to update business settings',
        ];
        ...
        return view('livewire.user.add-user-modal', get_defined_vars());
    }
