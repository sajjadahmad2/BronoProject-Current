...
class PermissionsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('assigned_to', function (Permission $permission) {
                ...
                return view(' user-management.permissions.columns._assign-to', compact('roles'));
            })
            ...
            ->addColumn('actions', function (Permission $permission) {
                return view(' user-management.permissions.columns._actions', compact('permission'));
            })
            ->setRowId('id');
    }
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->orderBy(0)
            ->drawCallback("function() {" . file_get_contents(resource_path('views/user-management/permissions/columns/_draw-scripts.js')) . "}");
    }
