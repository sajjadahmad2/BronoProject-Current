...
<link rel="stylesheet" href="{{ asset('gallery_plugin/css/jquery.flex-photo-gallery.css') }}" />
                        ...
                        @foreach ($stats as $key => $stat)
                            ...
                            <div class="col-6">
                                ...
                                <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                    ...
                                    <!--begin::Stats-->
                                    <div class="m-0" data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="{{ number_format($data_stats[$key]) }}">
                                        <!--begin::Number-->
                                        <span
                                            class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ number_format_short($data_stats[$key]) }}</span>
                                        <!--end::Number-->
    ...
    <div class="col-xl-8 ">
                    ...
                    <div class="position-relative fs-2x z-index-2 fw-bold text-white mb-7">
                        <span class="me-2">
                            ...
                            <span class="position-relative d-inline-block text-danger">
                                <a href="#"
                                    class="text-danger opacity-75-hover">{{ auth()->user()->first_name ?? 'Howdy' }}!</a>
        ...
        <div class="row g-5 g-xl-10">
                                            ...
                                            <span class="symbol-label bg-light-success">
                                                @if (!empty($user->photo) && file_exists(public_path($user->photo)))
                                                    <img src="{{ asset($user->photo) }}"
                                                        alt="{{ $user->first_name }}" class="h-100 w-100" />
                                                @else
                                                ...
                                                <div class="d-flex flex-column flex-shrink-0">
                                                    ...
                                                    <span
                                                        ...
                                                        <i class="ki-duotone ki-right-square fs-6 text-gray-600 me-2"><span
                                                                class="path1"></span><span class="path2"></span></i>
                                                        <span
                                                            class="badge badge-{{ $user->status == 1 ? 'success' : 'danger' }} fs-7 fw-bold">{{ $user->status == 1 ? 'active' : 'disabled' }}</span>
                                                    </span>
                                                    <!--end::Section-->
            ...
            <div class="col-xl-6 mb-5 mb-xl-10">
                ...
                @include('components.property_slider', ['properties' => $properties])
                <!--end::Slider Widget 2-->
            </div>
            <!--end::Col-->
        </div>
...
@section('js')
<script src="{{ asset('gallery_plugin/js/jquery.flex-photo-gallery.js') }}"></script>

<script>
    $('body').on('click', '.property-image', function() {
        ...
        $('#images-section .gallery-item:first-child').click();
