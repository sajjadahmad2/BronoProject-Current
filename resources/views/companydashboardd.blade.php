...
<div class='contacts_charts_container'>
    ...
    <div class="row gx-5 gx-xl-10">
        <div class="col-md-12 mb-3 d-flex justify-content-end align-items-center" style="gap: 20px;">
            ...
            <!--begin::Col for source input-->
            <div id="source-filter" class="d-none d-md-block" style="width: 10%; display:none;">
                <input
    ...
    <div class="row media gx-5 gx-xl-10 mb-xl-10">
        <!--begin::Col-->
                            ...
                            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-gray-800 fw-bold fs-4 me-3">{{
                                        number_format($cov['conversion_rate'], 2) }}%</span>
                                    <!--end::Number-->
        ...
        <div class="map bg-white col-xxl-6 mb-15 mb-xl-10">
            <!--begin::Card body-->
            <div id="group_by_countries" style="min-width: 70px; min-height: 95%;" data-kt-size="340" data-kt-line="22">
            </div>
        </div>
        ...
        <div class="main-div">
            <div class="row gx-5 gx-xl-10 mt-xl-10">
                <!--begin::Col-->
                <div class="col-lg-8 col-xl-8 col-xxl-8  mt-xl-20">
                ...
                <div class="col-lg-4 col-xl-4 col-xxl-4 col-xxl- mt-20 mb-xl-10">
                    <!--begin::List widget 9-->
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <img src="{{ asset('icons/facebook.png') }}" class="w-55px ms-n1 me-10"
                                                alt="">
                                            @elseif(strpos(strtolower($opportunity['source']), 'instagram') !== false)
                                            <img src="{{ asset('icons/instagram.png') }}" class="w-55px ms-n1 me-10"
                                                alt="">
                                            @elseif($opportunity['source'] === 'Direct Traffic')
                                            <img src="{{ asset('icons/youtube.png') }}"
                                                class="w-55px ms-n1 me-10" alt="">
                                            @else
                                            <img src="{{ asset('icons/google.png') }}" class="w-55px ms-n1 me-10"
                                                alt="">
                                            @endif
                                            <!--end::Icon-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <!--begin::Label-->
                                        <span
                                            class="badge {{ $key === 0 ? 'badge-light-success' : 'badge-light-danger' }}">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-4 border rounded bg-white p-4 shadow-sm">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8 text-gray-800 font-semibold ">{{ $opportunity['source'] ??
                                            'Unknows' }}
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 text-gray-800 font-semibold ">{{
                                            number_format($opportunity['percentage'],
                                            2) }}%
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid">
                                    <div
                                        class="tablecard card-grid min-w-full mb-4 border rounded bg-white p-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            <div data-datatable="true" data-datatable-page-size="5"
                                                ...
                                                <div class="overflow-y-auto">
                                                    <table
                                                        class="table-f-display table-auto table-border text-lg w-full"
                                                        ...
                                                        <thead>
                                                            <tr class="bg-light fw-bold">
                                                                ...
                                                                <th class="w-[100px] text-center py-3 px-4">Total Value
                                                                </th>
                                                                <th class="w-[100px] text-center py-3 px-4">Percentage
                                                                </th>
                                                            </tr>
                                                        </thead>
        ...
        $("#kt_daterangepicker_4").on('apply.daterangepicker', function(ev, picker) {
            if (picker.chosenLabel === "All Data") {
                ...
                $("#kt_daterangepicker_4").val(picker.startDate.format("MMMM D, YYYY") + " - " + picker.endDate.format("MMMM D, YYYY"));
