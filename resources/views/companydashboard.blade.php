...
<div class='contacts_charts_container'>
    {{-- Contacts filters row --}}
     <div class="row  gx-xl-10 mb-xl-2">
        ...
        <!--begin::User Section (50%)-->
        <div class="col-12 col-md-6 green-patti-1">
            <div class="d-flex justify-content-center bg-success rounded border-primary flex-wrap mt-0">
                <div class="d-flex align-items-center py-2 px-2">
                    <div class="fw-semibold fs-6 text-white">User 1</div>
                </div>
                <div class="d-flex align-items-center py-2 px-2">
                    <div class="fw-semibold fs-6 text-white">User 2</div>
                </div>
                <div class="d-flex align-items-center py-2 px-2">
                    <div class="fw-semibold fs-6 text-white">User 3</div>
                </div>
                <div class="d-flex align-items-center py-2 px-2">
                    <div class="fw-semibold fs-6 text-white">User 4</div>
                </div>
                <div class="d-flex align-items-center py-2 px-2">
                    <div class="fw-semibold fs-6 text-white">User 5</div>
                </div>
            </div>
        </div>
        <!--end::User Section-->

        <!--begin::Filter Section (50%)-->
        <div class="col-12 col-md-6 d-flex flex-column justify-content-end">
            <div class="d-flex flex-column flex-md-row gap-3">
                <!-- User Filter -->
                <div class="flex-grow-1 green-patti-4">
                    <select id="user-select" class="form-select form-select-sm px-3 py-2 rounded-md border border-gray-300 shadow-sm focus:ring-2 focus:ring-[#f8285a] focus:border-[#f8285a] transition duration-300 ease-in-out">
                        <option value="">Select User</option>
                        @foreach ($users as $user)
                            <option value="{{ $user['id'] }}">{{ $user['name'] }}</option>
                        @endforeach
                ...
                <!-- Source Filter -->
                <div class="flex-grow-1 green-patti-4">
                    <select id="source-select" class="form-select form-select-sm px-3 py-2 rounded-md border border-gray-300 shadow-sm focus:ring-2 focus:ring-[#f8285a] focus:border-[#f8285a] transition duration-300 ease-in-out">
                        <option value="">Select Source</option>
                        @foreach ($sources as $key => $source)
                            <option value="{{ $key }}">{{ $source }}</option>
                        @endforeach
                ...
                <!-- Date Range Picker -->
                <div class="flex-grow-1 green-patti-4">
                    <input type="text" class="form-control form-control-sm px-3 py-2 rounded-md border border-gray-300 shadow-sm focus:ring-2 focus:ring-[#f8285a] focus:border-[#f8285a] transition duration-300 ease-in-out"
                        placeholder="January 4, 2000 - December 1, 2023" id="kt_daterangepicker_4" />
                </div>
                <!--end::Date Range Picker-->
            </div>
