                            ...
                            <div class="col-md-8">
                                <div class="chart-customizer customizer-main">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="innerTextFontSize" name="innerTextFontSize" value="{{ isset($css_json['innerTextFontSize']) ? $css_json['innerTextFontSize'] : '' }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="labelsFontSize" name="labelsFontSize" value="{{ isset($css_json['labelsFontSize']) ? $css_json['labelsFontSize'] : '' }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="radio" id="labelsFontColorCodeRadio" name="labelsFontColorType"
                                            ...
                                            {{ isset($css_json['labelsFontColorType']) && $css_json['labelsFontColorType'] == 'code' ? 'checked' : '' }}> Code
                                        ...
                                        <input type="radio" id="labelsFontColorPickerRadio" name="labelsFontColorType"
                                            ...
                                            {{ isset($css_json['labelsFontColorType']) && $css_json['labelsFontColorType'] == 'picker' ? 'checked' : '' }}> Picker
                                    ...
                                    <div>
                                        ...
                                        <input type="radio" id="chartFillColorCodeRadio" name="chartFillColorType"
                                            ...
                                            {{ $css_json['chartFillColorType'] == 'code' ? 'checked' : '' }}
                                            > Code
                                        <input type="radio" id="chartFillColorPickerRadio" name="chartFillColorType"
                                            ...
                                            {{ $css_json['chartFillColorType'] == 'picker' ? 'checked' : '' }}
                                            > Picker
                                    ...
                                    <div>
                                        ...
                                        <input type="radio" id="chartStrokeColorCodeRadio" name="chartStrokeColorType"
                                            ...
                                            {{ $css_json['chartStrokeColorType'] == 'code' ? 'checked' : '' }}
                                            > Code
                                        <input type="radio" id="chartStrokeColorPickerRadio"
                                            ...
                                            {{ $css_json['chartStrokeColorType'] == 'picker' ? 'checked' : '' }}
                                            > Picker
        ...
        function copyCSS(makealert = true) {
            ...
            //conversation section
              css += `.hl_conversations--wrap .hl_conversations--messages-list-v2,
                            ...
                            .hl-modal
                            {\n`;
            css += `  background-color: ${globalbgColorType === 'code' ? document.getElementById('globalbgColorCode').value : document.getElementById('globalbgColorPicker').value} !important;\n`;
            css += `  color: ${globalfontColor} !important;\n`;
            css += `}\n`;
            ...
            css += `#location-switcher-sidbar-v2, #globalSearchOpener, #quickActions, .hl_v2-location_switcher, .n-date-picker#location-dashboard_date-picker .n-input {\n`;
            css += `  background-color: ${globalbgColorType === 'code' ? document.getElementById('globalbgColorCode').value : document.getElementById('globalbgColorPicker').value} !important;\n`;
            css += `  color: ${globalfontColor} !important;\n`;
            css += `}\n`;
            ...
            fetch("{{ route('style.dashboard.save') }}", {
                ...
                .then(data => {
                    if (data.status === 'success') {
                        alert('CSS and Design saved successfully!');
                    } else {
                        alert('Failed to save CSS and Design!');
                    }
                });
        });
