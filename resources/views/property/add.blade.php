    ...
    <div id="kt_app_content_container" class="app-container  container-xxl "
        ...
        <form action="{{ isset($property) ? route('property.save', $property->id) : route('property.save') }}"
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10" data-select2-id="select2-data-142-usbz">
                {{--  <div class="sticky bottom-0 bg-white border-t border-gray-200 p-4 z-50">  --}}
                ...
                <ul class=" nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2" role="tablist">
                    ...
                    <div class="d-flex" style="margin-left: auto">
                        <!-- Back Button -->
                        <a href="{{ url()->previous() }}" class="btn btn-light-primary fw-bolder me-2">
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10">
                                                ...
                                                @foreach ($property->images as $index => $image)
                                                    <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                                        <img src="{{ asset($image->url) }}" alt="Property Image"
                                                            class="d-block w-100 h-75 carousel-image" loading="lazy">
                                                    </div>
                                                @endforeach
                                            </div>
                                            <!-- Controls -->
                            ...
                            <div class="card card-flush py-1">
                                 ...
                                 <div class="card-body pt-0">
                                    ...
                                    <div class="row mt-4">
                                        <!-- Property Title -->
                                        <div class="col-lg-6 col-12 fv-row fv-plugins-icon-container">
                                            <label class="required form-label">Property Title</label>
                                            <input type="text" name="property_title"
                                                @if (isset($permissions['property_title']) && !$permissions['property_title']->editable) disabled @endif 
                                                class="form-control mb-2"
                                                placeholder="Property title"
                                                value="{{ old('property_title', $property->property_title ?? '') }}" required>
                                            <div class="text-muted fs-7">A property title is required and recommended to be SEO friendly.</div>
                                        ...
                                        <div class="col-lg-6 col-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control"
                                                @if (isset($permissions['ref']) && !$permissions['ref']->editable) disabled @endif 
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10" data-select2-id="select2-data-140-grm0">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        <!--begin::Label-->
                                        <label class="required form-label">Location Detail</label>
                                        <!--end::Label-->
